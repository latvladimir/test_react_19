...
const ThemedCard = () => {
    ...
    return (
        <div
            className={`max-w-md mx-auto shadow-md rounded-lg p-6 transition-all ${
        ...
        >
            ...
            <p className={theme === 'light' ? 'text-gray-800' : 'text-white'}>
                ...
                neque libero. Nullam mattis metus a sapien tempor, sit amet
                mollis est facilisis. Phasellus nec turpis nec dui venenatis
                vestibulum. Sed dapibus dapibus justo, at rhoncus risus
